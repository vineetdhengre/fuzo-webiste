...
const ProductShowcase = () => {
  ...
  const product = {
    title: "THE BESTSELLER BOX - PERFECT FOR FIRST TIMERS!",
    price: 599,
    originalPrice: 630,
    images: [
    ...
    description: "Calling all health-curious snackers and wellness newbies - this is your ultimate starter pack to discover the world of healthy snacking."
  };
